...
if ($('.body-main-slider').length > 0) {
	$('.body-main-slider').slick({
			...
			autoplaySpeed: 3000,
			//asNavFor:'',
			appendDots: $('.control-main-slider')
			// appendArrows: $('.slider-control'),
			// nextArrow: '<button type="button" class="slider-control__arrow slider-control__arrow-next"></button>',
			// prevArrow: '<button type="button" class="slider-control__arrow slider-control__arrow-prev"></button>',
			// responsive: [{
			// 	breakpoint: 768,
			// 	settings: {}
			// }]
...
if ($('.body-products-slider').length > 0) {
	$('.body-products-slider').slick({
			adaptiveHeight: true,
			//autoplay: true,
			infinite: false,
			dots: false,
			...
			autoplaySpeed: 3000,
			//asNavFor:'',
			// appendDots: $('.control-products-slider__arrows')
			appendArrows: $('.control-products-slider__arrows'),
			// nextArrow: '<button type="button" class="slider-control__arrow slider-control__arrow-next"></button>',
			// prevArrow: '<button type="button" class="slider-control__arrow slider-control__arrow-prev"></button>',
			responsive: [
				{
...
//<Filter>==========================================================================================
$('.slider-filter__option').click(function (event) {
	var i=$(this).data('filter');
	if (i==1) {
		$('.item-body-products-slider').show();
	}else{
		$('.item-body-products-slider').hide();
		$('.item-body-products-slider.f_'+i).show();
	}
	$('.slider-filter__option').removeClass('active');
